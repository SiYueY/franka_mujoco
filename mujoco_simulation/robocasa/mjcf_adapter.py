...
def adapt_mjcf(
    ...
    *,
    ...
    _insert_robot_include(root, robot_xml_path)
...
def _insert_robot_include(root: ET.Element, robot_xml_path: str | Path) -> None:
    """Insert a project robot MJCF include into the root ``<mujoco>`` element."""
    ...
    include.set("file", str(path))

    # MuJoCo accepts include elements directly under <mujoco>. Inserting it near
    # the beginning keeps the generated XML easy to inspect.
